...
import (
	...
	"github.com/crossplane-contrib/provider-upjet-ec/apis"
	"github.com/crossplane-contrib/provider-upjet-ec/apis/v1alpha1"
	"github.com/crossplane-contrib/provider-upjet-ec/config"
	"github.com/crossplane-contrib/provider-upjet-ec/internal/clients"
	"github.com/crossplane-contrib/provider-upjet-ec/internal/controller"
	"github.com/crossplane-contrib/provider-upjet-ec/internal/features"
)

func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Upjet-EC").DefaultEnvars()
	...
	log := logging.NewLogrLogger(zl.WithName("provider-upjet-ec"))
	if *debug {
	...
	mgr, err := ctrl.NewManager(cfg, ctrl.Options{
		...
		LeaderElectionID: "crossplane-leader-election-provider-upjet-ec",
		Cache: cache.Options{
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup Upjet-EC controllers")
