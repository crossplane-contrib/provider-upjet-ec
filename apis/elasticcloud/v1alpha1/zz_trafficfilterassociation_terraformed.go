...
func (mg *TrafficFilterAssociation) GetTerraformResourceType() string {
	return "ec_deployment_traffic_filter_association"
}
...
// LateInitialize this TrafficFilterAssociation using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *TrafficFilterAssociation) LateInitialize(attrs []byte) (bool, error) {
	params := &TrafficFilterAssociationParameters{}
